    ...
    <main>
      ...
      <div class="post-writer">
        <div class="container">
          ...
          <div class="con-right">
            <div class="post-body">
              <textarea v-model="contents" @input="mixin_auto_resize" rows="1" placeholder="What's happening?"></textarea>
              <UploadImages :max="4" @changed="handleImages" ref="plusClick" />
            </div>
            <div class="post-footer">
              <div class="post-footer-left">
                <span class="image-invoker" @click="plusClick">
