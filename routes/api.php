...
Route::get('letters/search', [LetterController::class, 'index'])->name('letters.index');
Route::get('letters/{letter}/{user_id?}', [LetterController::class, 'show'])->name('letters.show');
Route::post('letters', [LetterController::class, 'store'])->name('letters.store');
Route::post('letters2', [LetterController::class, 'store2'])->name('letters.store2');
